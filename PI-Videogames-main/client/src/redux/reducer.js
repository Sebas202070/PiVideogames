...
import { GET_ALL_VIDEOGAMES, GET_VIDEOGAME_DETAIL, POST_VIDEOGAME, GET_GENRES,GET_VIDEOGAMES_BY_NAME, CLEAN_SEARCH, CLEAN_DETAIL, FILTER_BY_CREATION, FILTER_BY_GENRE, ORDER_BY_NAME, ORDER_BY_RATING, SET_SEARCH } from "./actions"
...
const rootReducer = (state = initialState, action) => {
    switch (action.type) {
      ...
      case GET_VIDEOGAME_DETAIL:
        ...
        case POST_VIDEOGAME:
          return {...state, videogamesloaded:[...state.videogamesloaded, action.payload]}
